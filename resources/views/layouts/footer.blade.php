        ...
        <div class="container mx-auto">
            <div class="footer_wrapper flex justify-end items-center">
                ...
                <div class="footer_right">
                    <h2 class="text-h1 text-secondary">Let`s Talk</h2>
                    <p>
                        <a href="mailto:info@smiple.com">info@smiple.com</a>
                    </p>
                    <p>
                        <a href="tel:+93 799 540 922">+93 799 540 922</a>
                    </p>
                    ...
                    <div class="flex flex-sm-col flex-md-row justify-between mt-[85px]">
                        <ul class="flex flex-col gap-3">
                            <li><a href="#"
                                    class="border-b-[2px] border-b-secondary-500 menu-link text-secondary-500">Projects</a>
                            </li>
                            <li><a href="#"
                                    class="border-b-[2px] border-b-secondary-500 menu-link text-secondary-500">Services</a>
                            </li>
                            <li><a href="#"
                                    class="border-b-[2px] border-b-secondary-500 menu-link text-secondary-500">About
                                    Us</a></li>
                            <li><a href="#"
                                    class="border-b-[2px] border-b-secondary-500 menu-link text-secondary-500">Contact</a>
                            </li>

                        </ul>
                        <div class="addresses max-w-[300px]">
                            <h3 class="text-h4 text-secondary-500 mb-5">Afghanistan</h3>
                            <p class="text-p1 text-secondary-500 text-light">4th apt, 1st floor, Hedayat darwish plaza,
                                Karte char, Mukhaberat street, Kabul.</p>

                            <h3 class="text-h4 text-secondary-500 mt-[35px] mb-5">Registered</h3>
                            <p class="text-p1 text-secondary-500 text-light">ACBR-IP</p>
                    ...
                    <p>© 2025 simple studio  I  Privacy policy  I  cookie policy</p>
